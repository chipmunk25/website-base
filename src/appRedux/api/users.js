...
export function* Logout(token, data) {
    try {
        return yield API().post(`/users/logout`, { ...data }, { headers: { Authorization: "Bearer " + token } })
    } catch (error) {
        return yield error.response
    }
}
...
export function* RemoveBranch(token, data) {
    try {
        return yield API().patch(`/companies/branch/${data.id}/soft`, { ...data }, { headers: { Authorization: "Bearer " + token } })
    } catch (error) {
        return yield error.response
    }
}
...
export function* RemoveUser(token, data) {
    try {
        return yield API().patch(`/users/${data.id}/soft`, { ...data }, { headers: { Authorization: "Bearer " + token } })
    } catch (error) {
        return yield error.response
    }
}
...
export function* RemoveRole(token, data) {
    try {
        return yield API().patch(`/users/role/${data.id}/soft`, { ...data }, { headers: { Authorization: "Bearer " + token } })
    } catch (error) {
        return yield error.response
    }
}
...
export function* RemovePermission(token, data) {
    try {
        return yield API().patch(`/users/permission/${data.id}/soft`, { ...data }, { headers: { Authorization: "Bearer " + token } })
    } catch (error) {
        return yield error.response
    }
}
